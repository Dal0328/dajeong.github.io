...
const questions = [
    ...
    },
    {
        ...
        scenario: [
            "친구: 오늘 도서관에서 신간 잡지를 봤어. 책 표지에서부터 디테일이 살아있더라구.",
            "나: 난 언제나 책 속의 작은 정보 하나하나에 매력을 느끼거든.",
            "친구: 너답게 꼼꼼하게 정보를 챙기는 모습, 멋져!"
        ]
    },
    {
        ...
        scenario: [
            "친구: 수업 시간 토론할 때, 네가 갑자기 '내 직감대로 하자!'라고 한 거 기억나?",
            "나: 그때는 정말 고민 끝에 내 마음을 믿고 결정했었지.",
            "친구: 네 논리적인 설명도 좋았지만, 감정이 묻어난 그 한 마디가 아직도 웃겨."
        ]
    },
    {
        ...
        scenario: [
            "친구: 우리 반 행사 준비할 때, 넌 늘 달력에 다 표시해두고 움직였지.",
            "나: 그때는 계획이 전부인 줄 알았는데, 가끔은 즉흥적인 게 더 재밌더라구.",
            "친구: 이번에도 네 플랜이 빛을 발할지, 아니면 예측 불가의 변수가 등장할지 궁금해!"
        ]
    },
    {
        ...
        scenario: [
            "친구: 급식실에서 점심 먹을 때, 넌 보통 누구랑 앉았더라?",
            "나: 보통은 오랜 친구들이랑 모여서 수다 떨곤 했지. 물론 가끔은 혼자 조용히 먹기도 해.",
            "친구: 네가 고른 그 자리, 오늘도 그 느낌 그대로겠지?"
        ]
    },
    {
        ...
        scenario: [
            "친구: 지난번 시험 전날, 넌 노트 정리를 끝내고 '이젠 내가 살아있다!'고 외쳤지.",
            "나: 그때는 실제로 경험한 일들을 복기하며 공부했어.",
            "친구: 네가 기억하는 디테일 덕분에 모두 감탄했었어!"
        ]
    },
    {
        ...
        scenario: [
            "친구: 수업 중 그룹 토론에서 네가 '내 생각은 이래'라고 말할 때, 분위기가 팽팽했지.",
            "나: 난 그때 내 논리를 최대한 끌어내려고 애썼어.",
            "친구: 물론, 네 따뜻한 미소와 감정 표현도 잊을 수 없지."
        ]
    },
    {
        ...
        scenario: [
            "친구: 학창 시절 우리 팀 프로젝트 준비할 때, 넌 항상 리더답게 미리 플랜을 짰잖아.",
            "나: 맞아, 그때는 계획이 없으면 불안했으니까.",
            "친구: 그런데 이번엔 네가 예상치 못한 즉흥 아이디어로 우리를 놀라게 할지도 몰라!"
        ]
    }
];
